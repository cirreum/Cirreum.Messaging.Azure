# Cirreum.Messaging.Azure 1.1.0 — Configurable Credentials for Identity-Based Authentication
...
Set the connection value to the fully qualified namespace instead of an `Endpoint=...` connection string and the provider authenticates with Entra.
